      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              {socialLinks.map((item) => {
                ...
                if (item.isCopy) {
                  return (
                    <button
                      ...
                      title={copiedEmail ? "Email Berhasil Disalin!" : "Klik untuk salin email"}
                      aria-label="Salin Email"
                      className={`relative p-3 rounded-2xl border transition-all duration-300 hover:scale-110 shadow-md ${
                        isDarkMode 
                ...
                return (
                  <a
                    ...
                    className={`p-3 rounded-2xl border transition-all duration-300 hover:scale-110 shadow-md ${
                      isDarkMode 
                        ? 'bg-cosmos-900/80 border-indigo-900/50' 
                        : 'bg-white border-slate-200'
                    } ${item.color}`}
          ...
          <div className="lg:col-span-6">
            <div className={`p-6 sm:p-7 rounded-2xl border shadow-2xl transition-colors ${
              isDarkMode 
              ...
              {/* Form Window Header */}
              <div className="flex items-center justify-between border-b pb-3.5 mb-4 border-indigo-900/20">
              ...
              <form onSubmit={handleFormSubmit} className="space-y-3.5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3.5 py-2.5 rounded-xl border text-sm transition-colors outline-none focus:border-indigo-500 ${
                      isDarkMode 
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-3.5 py-2 rounded-xl border text-sm transition-colors outline-none focus:border-indigo-500 resize-none ${
                      isDarkMode 
                        ? 'bg-cosmos-950/60 border-indigo-900/40 text-white placeholder-slate-500' 
                        : 'bg-slate-50 border-slate-200 text-slate-800 placeholder-slate-400'
                    }`}
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold text-sm shadow-lg shadow-emerald-600/30 transition-all duration-300 hover:scale-[1.01]"
                >
