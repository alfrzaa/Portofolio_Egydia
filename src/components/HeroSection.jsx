                ...
                {!isFlipped ? (
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    {cardMode === 'photo' ? (
                      ...
                      <div className="relative w-full h-[320px] rounded-xl overflow-hidden bg-[#070a14] border border-indigo-500/40 flex flex-col items-center justify-center p-4">
                        ...
                        {/* Top Badges */}
                        <div className="absolute top-3 inset-x-3 flex items-center justify-between text-[10px] font-mono z-20">
                        ...
                        <img 
                          ...
                          className="w-40 h-auto relative z-10 [image-rendering:pixelated] drop-shadow-[0_10px_25px_rgba(99,102,241,0.6)] transition-transform duration-300 group-hover:scale-110"
                        />

                        {/* Retro Game Stats Bar */}
                        <div className="absolute bottom-3 inset-x-3 z-20 flex items-center justify-between text-[10px] font-mono text-white/90 bg-black/80 backdrop-blur-md px-3 py-1.5 rounded-lg border border-indigo-500/30">
                          <span className="text-emerald-400 font-bold">HP: 100/100</span>
                          <span className="text-cyan-400 font-bold">MANA: 100/100</span>
